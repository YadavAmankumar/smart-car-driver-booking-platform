...
function AdminSidebar({
  ...
  // Matches the styling approach used by CustomerSidebar.
  const items: Array<{ label: string; href?: string; onClick?: () => void }> = [
    { label: "Dashboard", href: "/admin/dashboard" },
    { label: "Bookings", href: "/admin/dashboard" },
    { label: "Cars", href: "/admin/dashboard" },
    { label: "Drivers", href: "/admin/dashboard" },
    { label: "Customers", href: "/admin/dashboard" },
    { label: "Payments", href: "/admin/dashboard" },
    { label: "Pricing", href: "/admin/dashboard" },
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-slate-200 bg-white/70 p-5 shadow-sm">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-600">Overview, bookings, fleet, and analytics.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-xs text-slate-600">Admin modules will render here.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <p className="text-sm font-semibold text-slate-900">Bookings</p>
              <p className="mt-2 text-xs text-slate-600">Admin bookings tools will render here.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <p className="text-sm font-semibold text-slate-900">Settings</p>
              <p className="mt-2 text-xs text-slate-600">Admin settings tools will render here.</p>
            </div>
          </div>
        </div>
      )}
